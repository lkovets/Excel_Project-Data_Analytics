...
This project was completed as part of a data analysis course, where I explored the data job market using Excel’s advanced tools.
The goal was to understand which skills matter most, how salaries vary across regions, and what employers look for in higher-paying roles.
...
Completing this project as part of the course helped me practice Power Query, Power Pivot, DAX, and PivotCharts while uncovering valuable insights about the data job market.
The analysis showed strong links between technical skills, location, and salary levels — especially for Python, SQL, and cloud technologies.
